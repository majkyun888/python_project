...
from tools.util import BBoxUtility,letterbox_image,ssd_correct_boxes

class SSD(object):

    _defaults = {
        "model_path": 'model_data/ep100-loss2.889-val_loss2.842.h5',
    ...
    def detect_image(self, image):
        ...
        results = self.bbox_util.detection_out(preds, confidence_thresholde=self.confidence)
        if len(results[0]) <= 0:
            return image
